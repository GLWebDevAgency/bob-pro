...
DO $bob_m2a2_validate_missions_owner$
DECLARE
  owner_oid OID;
  owner_name TEXT;
BEGIN
  ...
  IF current_user::pg_catalog.regrole <> owner_oid THEN
    IF owner_name IS NULL
      ...
      RAISE EXCEPTION USING
        ERRCODE = '42501',
        MESSAGE = 'AGENT_MISSION_M2A2_VALIDATE_MISSIONS_OWNER_UNAVAILABLE';
    END IF;
  ...
  IF current_user::pg_catalog.regrole <> owner_oid THEN
    RAISE EXCEPTION USING
      ERRCODE = '42501',
      MESSAGE = 'AGENT_MISSION_M2A2_VALIDATE_MISSIONS_OWNER_NOT_ASSUMED';
  END IF;
END;
$bob_m2a2_validate_missions_owner$;
...
DO $bob_m2a2_validate_events_owner$
DECLARE
  owner_oid OID;
  owner_name TEXT;
BEGIN
  ...
  IF current_user::pg_catalog.regrole <> owner_oid THEN
    IF owner_name IS NULL
      ...
      RAISE EXCEPTION USING
        ERRCODE = '42501',
        MESSAGE = 'AGENT_MISSION_M2A2_VALIDATE_EVENTS_OWNER_UNAVAILABLE';
    END IF;
    EXECUTE pg_catalog.format('SET LOCAL ROLE %I', owner_name);
  END IF;
  ...
  IF current_user::pg_catalog.regrole <> owner_oid THEN
    RAISE EXCEPTION USING
      ERRCODE = '42501',
      MESSAGE = 'AGENT_MISSION_M2A2_VALIDATE_EVENTS_OWNER_NOT_ASSUMED';
  END IF;
END;
$bob_m2a2_validate_events_owner$;
...
DO $bob_m2a2_validate_line_work_owner$
DECLARE
  owner_oid OID;
  owner_name TEXT;
BEGIN
  ...
  IF current_user::pg_catalog.regrole <> owner_oid THEN
    IF owner_name IS NULL
      ...
      RAISE EXCEPTION USING
        ERRCODE = '42501',
        MESSAGE = 'AGENT_MISSION_M2A2_VALIDATE_LINE_WORK_OWNER_UNAVAILABLE';
    END IF;
    EXECUTE pg_catalog.format('SET LOCAL ROLE %I', owner_name);
  END IF;
  ...
  IF current_user::pg_catalog.regrole <> owner_oid THEN
    RAISE EXCEPTION USING
      ERRCODE = '42501',
      MESSAGE = 'AGENT_MISSION_M2A2_VALIDATE_LINE_WORK_OWNER_NOT_ASSUMED';
  END IF;
END;
$bob_m2a2_validate_line_work_owner$;
