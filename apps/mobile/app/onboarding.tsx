...
import { TRADE_PROFILES } from '@bob/core';
...
export default function Onboarding() {
  ...
  const selected = trades.find((t) => t.trade === trade) ?? null;
    ...
    >
      ...
      {selected ? (
        <Card>
          ...
          <Text style={[font('sub'), { color: colors.slate400, marginTop: 2 }]}>Bob met en avant les bons modules :</Text>
