...
| O4 — mission continue         | certified sur staging pour M1-B — recovery `30334601843`, vraie mission WebRTC + ACK contexte/RLS `30335132334`, retour OFF et Bob Live restauré ; fusionné dans `main@9a17ee85`, endpoints production toujours fermés ; planificateur sémantique Jarvis spécifié dans `SPEC_BOB_LIVE_SEMANTIC_PLANNER.md` | M1-C compréhension typée + scénario devis E2E voix/tap sur données réelles, puis QA device                                                        |
