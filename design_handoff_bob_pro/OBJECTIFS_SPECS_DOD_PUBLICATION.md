...
| O5 — Voice Trace              | specified — le traceur HTTP V1 est implémenté mais dormant et hors du chemin GPT Realtime ; le train V2 staging-only est spécifié dans `SPEC_VOICE_TRACE_REALTIME_V2_STAGING.md`, sans activation ni certification à ce stade                                                                                                                                                                                                                                                                                                                                                                                                                                                          | journal V2 réellement câblé bootstrap/sideband/planner/ACK + tests confidentialité/RLS + Supabase staging + OFF→ON→OFF→ON exact-SHA ; dashboard p50/p95 et preuves device ensuite               |
