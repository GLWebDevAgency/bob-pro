...
Le mot « logs » désigne ici Railway, Sentry, les métriques et les artefacts CI : aucun transcript ni
réponse Bob n'y entre. La campagne interne preview/staging peut conserver la chaîne finale et la
réponse canonique dans le journal souverain dédié décrit par
[SPEC_VOICE_TRACE_REALTIME_V2_STAGING.md](SPEC_VOICE_TRACE_REALTIME_V2_STAGING.md), uniquement pour
les couples tenant/utilisateur explicitement autorisés, chiffrées applicativement, sous RLS forcée
et avec une rétention maximale de 30 jours. Cette exception d'observation n'autorise ni audio, ni
payload provider, ni argument d'outil libre, et ne s'applique jamais à la production.
...
| Objectif                      | État au 2026-08-01                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Prochaine preuve attendue                                                                                                                                                                       |
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| O3 — GPT Realtime             | `implemented` partiellement — PR85 fusionnée dans `main@2e36622e` pose Mission V2 native et les fences générationnelles, sans activation. Le rail audité reste publié ; les traces terrain du 10/08 prouvent son incompatibilité SDP et son cold-probe. Compile-lock, autorité SDP serveur, contrôle `provider_stream`, politique acoustique, readiness/minimum-client et opérateur restent à solder. | Une seule PR active à la fois : PR86 autorité SDP + bootstrap vertical pré-contrôle → lifecycle local/sign-out provider-neutral → `provider_stream/v2` phase A dormante → readiness/minimum-client/fermeture legacy/opérateur → phase B exact-SHA → canary, APK et QA Android/iPhone. |
