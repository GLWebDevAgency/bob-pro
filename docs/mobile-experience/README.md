...
> Dernière mise à jour : 2026-07-29 (amendements A1 → A14, voir § Journal des amendements)
...
**Portée hors dossier.** `A10`, `A11` et `A12` amendent des documents canoniques **hors**
